...
function UserGuide() {
    ...
    useEffect(() => {
        setShowStep('create')
        setStepContent(
            <p className='text-sm text-white px-8 lg:px-2 mt-4 text-left'>To create a MetaMask wallet, visit MetaMask.io, install the extension, set a password, jot down the seed phrase, confirm it, choose a network, and voila! You're all set to start using your wallet.</p>
        )
    },[]);
    ...
    const handleClick = (e) => {
        ...
        if (id === 'create') {
            ...
            setShowStep('get')
            setStepContent(
                <p className='text-sm text-white px-8 lg:px-2 mt-4 text-left'>To get Ethereum (ETH) in your MetaMask wallet, either purchase ETH directly within MetaMask or transfer ETH from a cryptocurrency exchange or another wallet by copying your MetaMask wallet address and initiating the transfer.</p>
            )
        } else if (id === 'bridge') {
            setShowStep('bridge')
            setStepContent(
                <p className='text-sm text-white px-8 lg:px-2 mt-4 text-left'>To bridge Ethereum (ETH) to the zkSync network, visit <a className="underline text-main"
            ...
            setShowStep('swap')
            setStepContent(
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-6 px-8 lg:px-2">
                    <div className="col-span-1 text-white text-sm text-left">
                        ...
                        <a href="https://syncswap.xyz/" className='flex mt-2 lg:mt-10'>
                    ...
                    <div className="col-span-1 text-white text-sm text-left">
                        ...
                        <a href="https://izumi.finance/" className='flex mt-2 lg:mt-6'>
